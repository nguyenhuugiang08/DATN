...
const ManUnderwear = () => {
    ...
    const [sort, setSort] = useState<number | string>(localStorage.getItem("sort-underwear") || "");
    ...
    return (
        <Container maxWidth='xl' sx={{ marginBottom: "32px" }}>
            <Grid className={classes.filterHeading}> Quần lót nam</Grid>
            <Grid
                sx={{
                    width: "max-content",
                    display: "flex",
